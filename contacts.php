...
<section class="relative z-10 overflow-hidden bg-zinc-900 py-5 px-10 lg:py-[30px]">
  <div class="container mx-auto">
    <div class="mx-4 grid justify-items-center">
          

          <span class="text-[#ff0000] mb-4 block text-base font-semibold">
            GET IN TOUCH WITH US
          </span>
          
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
              class="bg-primary text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
            >
              <svg
                width="24"
                height="24"
            ...
            <div class="w-full">
              <h4 class="text-white mb-1 text-xl font-bold">Our Location</h4>
              <p class="text-white text-base">
                Naivas Mall, 1st Floor
              </p>
              <p class="text-white text-base">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-white mb-1 text-xl font-bold">Phone Number</h4>
              <p class="text-white text-base">0721 472 959</p>
              <p class="text-white text-base">0786 560 821</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-white mb-1 text-xl font-bold">Email Address</h4>
              <p class="text-white text-base">grandcs@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
